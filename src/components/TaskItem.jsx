...
import { removeTaskAction } from '../redux/actions/listsAction';

function TaskItem({ text, id }) {
  ...
  return (
    <div className="task__item">
      <div
        ...
        className={`task__check ${checkItem && 'activeTask'}`}>
        <i>
          <svg
            width="11"
            height="8"
      ...
      <h3 className="task__text">{text}</h3>
      <div onClick={() => onRemove(id)} className="removeIcon">
        <i>
          <svg
            width="10"
            height="10"
